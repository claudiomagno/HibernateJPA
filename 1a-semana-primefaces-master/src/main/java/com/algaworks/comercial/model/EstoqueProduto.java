...
/**
 * EstoqueProduto generated by hbm2java
 */
@Entity
@Table(name = "estoque_produto", catalog = "semana")
public class EstoqueProduto implements java.io.Serializable {
	...
	public EstoqueProduto(EstoqueProdutoId id, Estoque estoque,
			Produto produto, int numSerie) {
		this.id = id;
	...
	public EstoqueProduto(EstoqueProdutoId id, Estoque estoque,
			Produto produto, String notaFiscal, int numSerie,
			String tipoMovimento, Date dataMovimento) {
		this.id = id;
		this.estoque = estoque;
		this.produto = produto;
	...
	public EstoqueProdutoId getId() {
		return this.id;
	}

	public void setId(EstoqueProdutoId id) {
		this.id = id;
	}
